<?php
/* Smarty version 4.5.3, created on 2026-04-17 18:19:47
  from 'F:\xampp\htdocs\billingnet\system\plugin\ui\wga.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_69e21753277224_79167372',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e5534c707186246ad6070c716d57fe2f08e3ff41' => 
    array (
      0 => 'F:\\xampp\\htdocs\\billingnet\\system\\plugin\\ui\\wga.tpl',
      1 => 1769883350,
      2 => 'file',
    ),
  ),
...
function content_69e21753277224_79167372 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'F:\\xampp\\htdocs\\billingnet\\system\\vendor\\smarty\\smarty\\libs\\plugins\\modifier.count.php','function'=>'smarty_modifier_count',),));
            ...
            <div class="col-sm-12 col-md-12">
                <div class="panel panel-primary panel-hovered panel-stacked mb30">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo Lang::T('Alternative WhatsApp Gateway Settings');?>
</h3>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo Lang::T('Server URL');?>
</label>
                            <div class="col-md-6">
                                <input type="password" class="form-control" required id="alt_wga_server_url"
                                    name="alt_wga_server_url" value="<?php echo $_smarty_tpl->tpl_vars['_c']->value['alt_wga_server_url'];?>
"
                                    placeholder="http://localhost:3000" onmouseleave="this.type = 'password'"
                                    onmouseenter="this.type = 'text'">
                                <span class="help-block"><?php echo Lang::T('WhatsApp Gateway API Server URL');?>
</span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label"><?php echo Lang::T('Device ID');?>
</label>
                            <div class="col-md-6">
                                <?php if ($_smarty_tpl->tpl_vars['devices']->value && empty($_smarty_tpl->tpl_vars['_c']->value['alt_wga_device_id']) && count($_smarty_tpl->tpl_vars['devices']->value) > 0) {?>
                                <select class="form-control" id="alt_wga_device_id" name="alt_wga_device_id">
                                    <option value=""><?php echo Lang::T('-- Select Device --');?>
</option>
                                    <?php
...
?>
                                    <?php $_smarty_tpl->_assignInScope('devId', (($tmp = $_smarty_tpl->tpl_vars['device']->value['id'] ?? null)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['device']->value['device'] ?? null : $tmp));?>
                                    <option value="<?php echo $_smarty_tpl->tpl_vars['devId']->value;?>
" <?php if ($_smarty_tpl->tpl_vars['_c']->value['alt_wga_device_id'] == $_smarty_tpl->tpl_vars['devId']->value) {?>selected<?php }?>>
                                        <?php echo $_smarty_tpl->tpl_vars['devId']->value;?>
 <?php if ($_smarty_tpl->tpl_vars['device']->value['display_name']) {?>(<?php echo $_smarty_tpl->tpl_vars['device']->value['display_name'];?>
)<?php } elseif ($_smarty_tpl->tpl_vars['device']->value['name']) {?>(<?php echo $_smarty_tpl->tpl_vars['device']->value['name'];?>
)<?php }?>
                                    </option>
                                    <?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                ...
                                <span class="help-block"><?php echo Lang::T('Select the WhatsApp device to use for sending
                                    messages');?>
</span>
                                <?php } else { ?>
                                <input type="password" class="form-control" id="alt_wga_device_id"
                                    name="alt_wga_device_id" value="<?php echo $_smarty_tpl->tpl_vars['_c']->value['alt_wga_device_id'];?>
"
                                    placeholder="device_id12345" onmouseleave="this.type = 'password'"
                                    onmouseenter="this.type = 'text'">
                                <span class="help-block"><?php echo Lang::T('Enter Device ID manually or save Server URL first to
                                    load devices');?>
</span>
                                <?php }?>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" id="alt_wga_username" name="alt_wga_username"
                                    value="<?php echo $_smarty_tpl->tpl_vars['_c']->value['alt_wga_username'];?>
" placeholder="admin">
                                <span class="help-block"><?php echo Lang::T('Basic Auth username for WhatsApp API server
                                    (optional)');?>
</span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" id="alt_wga_password"
                                    name="alt_wga_password" value="<?php echo $_smarty_tpl->tpl_vars['_c']->value['alt_wga_password'];?>
" placeholder="password"
                                    onmouseleave="this.type = 'password'" onmouseenter="this.type = 'text'">
                                <span class="help-block"><?php echo Lang::T('Basic Auth password for WhatsApp API server
                                    (optional)');?>
</span>
                            </div>
                        </div>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-info panel-hovered panel-stacked mb30">
                <div class="panel-heading">
                    <h3 class="panel-title"><?php echo Lang::T('Device Management');?>
</h3>
                </div>
                <div class="panel-body">
                    <!-- Active Device Display -->
                    <?php if ($_smarty_tpl->tpl_vars['_c']->value['alt_wga_device_id']) {?>
                    <div class="alert alert-info">
                        <i class="glyphicon glyphicon-phone"></i>
                        <strong><?php echo Lang::T('Active Device');?>
:</strong>
                        <code id="wga-active-device-display"><?php echo $_smarty_tpl->tpl_vars['_c']->value['alt_wga_device_id'];?>
</code>
                        <span class="pull-right">
                            <button class="btn btn-success btn-xs" type="button" onclick="wgaShowQrLogin()">
                                <i class="glyphicon glyphicon-qrcode"></i> <?php echo Lang::T('QR Login');?>

                            </button>
                            <button class="btn btn-primary btn-xs" type="button" onclick="wgaShowCodeLogin()">
                                <i class="glyphicon glyphicon-phone"></i> <?php echo Lang::T('Code Login');?>
                    ...
                    <div class="alert alert-warning">
                        ...
                        <?php echo Lang::T('No active device selected. Create a device and set it as active.');?>
                    ...
                    <div class="row" id="wga-device-setup">
                        <div class="col-md-12">
                            <h4><i class="glyphicon glyphicon-plus-sign"></i> <?php echo Lang::T('Create New Device');?>
</h4>
                            <div class="form-inline" style="margin-bottom: 15px;">
                                <div class="form-group">
                                    <input type="text" class="form-control" id="wga-new-device-id"
                                        placeholder="<?php echo Lang::T('Device ID (optional - leave empty to auto-generate)');?>
"
                                        style="width: 350px;">
                                </div>
                                <button class="btn btn-primary" type="button" onclick="wgaCreateDevice(event)">
                                    <i class="glyphicon glyphicon-plus"></i> <?php echo Lang::T('Create Device');?>

                                </button>
                            </div>
                            <div id="wga-device-created" class="alert alert-success" style="display:none;">
                                <i class="glyphicon glyphicon-ok-circle"></i>
                                <strong><?php echo Lang::T('Device Created!');?>
</strong>
                                <?php echo Lang::T('Device ID');?>
: <code id="wga-created-device-id"></code>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="wga-devices-container">
                        <div class="row">
                            <div class="col-md-6">
                                <h4><?php echo Lang::T('Connected Devices');?>
</h4>
                            </div>
                            <div class="col-md-6 text-right">
                                <button class="btn btn-default btn-sm" type="button" onclick="wgaRefreshDevices()">
                                    <i class="glyphicon glyphicon-refresh"></i> <?php echo Lang::T('Refresh List');?>
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo Lang::T('Device ID');?>
</th>
                                        <th><?php echo Lang::T('Status');?>
</th>
                                        <th width="220"><?php echo Lang::T('Actions');?>
</th>
                                    </tr>
                                </thead>
                                <tbody id="wga-devices-tbody">
                                    <?php if ($_smarty_tpl->tpl_vars['devices']->value && count($_smarty_tpl->tpl_vars['devices']->value) > 0) {?>
                                    <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['devices']->value, 'device');
$_smarty_tpl->tpl_vars['device']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['device']->value) {
$_smarty_tpl->tpl_vars['device']->do_else = false;
?>
                                    <?php $_smarty_tpl->_assignInScope('deviceId', (($tmp = $_smarty_tpl->tpl_vars['device']->value['id'] ?? null)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['device']->value['device'] ?? null : $tmp));?>
                                    <tr id="wga-device-row-<?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['deviceId']->value, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
">
                                        <td><?php echo htmlentities(mb_convert_encoding((string)(($tmp = (($tmp = $_smarty_tpl->tpl_vars['device']->value['display_name'] ?? null)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['device']->value['name'] ?? null : $tmp) ?? null)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['deviceId']->value ?? null : $tmp), 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>

                                        </td>
                                        <td><small><?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['deviceId']->value, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
</small></td>
                                        <td>
                                            <?php $_smarty_tpl->_assignInScope('deviceState', (($tmp = (($tmp = $_smarty_tpl->tpl_vars['device']->value['state'] ?? null)===null||$tmp==='' ? $_smarty_tpl->tpl_vars['device']->value['status'] ?? null : $tmp) ?? null)===null||$tmp==='' ? 'disconnected' ?? null : $tmp));?>
                                            <span
                                                class="label <?php if ($_smarty_tpl->tpl_vars['deviceState']->value == 'connected' || $_smarty_tpl->tpl_vars['deviceState']->value == 'online') {?>label-success<?php } else { ?>label-warning<?php }?>">
                                                <?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['deviceState']->value, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>

                                            </span>
                                        </td>
                                        <td>
                                            <?php if ($_smarty_tpl->tpl_vars['_c']->value['alt_wga_device_id'] == $_smarty_tpl->tpl_vars['deviceId']->value) {?>
                                            <span class="label label-primary">
                                                <i class="glyphicon glyphicon-ok"></i> <?php echo Lang::T('Active');?>

                                            </span>
                                            <?php } else { ?>
                                            <button class="btn btn-success btn-xs wga-set-active-btn"
                                                data-device-id="<?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['deviceId']->value, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
"
                                                title="<?php echo Lang::T('Set as Active');?>
">
                                                <i class="glyphicon glyphicon-ok"></i> <?php echo Lang::T('Set Active');?>
                                            ...
                                            <button class="btn btn-info btn-xs wga-reconnect-btn"
                                                data-device-id="<?php echo htmlentities(mb_convert_encoding((string)$_smarty_tpl->tpl_vars['deviceId']->value, 'UTF-8', 'UTF-8'), ENT_QUOTES, 'UTF-8', true);?>
"
                                                title="<?php echo Lang::T('Reconnect');?>
">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                    ...
                                    <tr id="wga-no-devices-row">
                                        <td colspan="4" class="text-center text-muted">
                                            <?php echo Lang::T('No devices found. Create a device first.');?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><i class="glyphicon glyphicon-qrcode"></i> <?php echo Lang::T('Login with QR Code');?>
</h4>
            </div>
            <div class="modal-body text-center">
                <div id="wga-qr-loading" class="text-center" style="padding: 40px;">
                    ...
                    <p><?php echo Lang::T('Loading QR Code...');?>
</p>
                </div>
                <div id="wga-qr-code-container" style="display:none;">
                    ...
                    <div id="wga-qr-status" class="alert alert-info" style="margin-top: 15px;">
                        ...
                        <span id="wga-qr-status-text"><?php echo Lang::T('Waiting for scan...');?>
</span>
                    </div>
                    <p class="text-muted" style="margin-top: 10px;">
                        <strong><?php echo Lang::T('How to scan:');?>
</strong><br>
                        1. <?php echo Lang::T('Open WhatsApp on your phone');?>
<br>
                        2. <?php echo Lang::T('Go to Settings > Linked Devices');?>
<br>
                        3. <?php echo Lang::T('Tap "Link a Device"');?>
<br>
                        4. <?php echo Lang::T('Scan this QR code');?>
                ...
                <div id="wga-qr-connected" class="alert alert-success" style="display:none;">
                    ...
                    <h4><?php echo Lang::T('Device Connected Successfully!');?>
</h4>
                    <p><?php echo Lang::T('You can now close this window.');?>
</p>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="wga-qr-refresh-btn" onclick="wgaRefreshQrCode()">
                    <i class="glyphicon glyphicon-refresh"></i> <?php echo Lang::T('Refresh QR');?>
...
<div class="modal fade" id="wgaPairingModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                <h4 class="modal-title"><i class="glyphicon glyphicon-phone"></i> <?php echo Lang::T('Login with Code');?>
</h4>
            </div>
                ...
                <div id="wga-pairing-form">
                    <div class="form-group">
                        <input type="text" class="form-control" id="wga-pairing-phone"
                            placeholder="<?php echo Lang::T('e.g., 2348012345678');?>
">
                    </div>
                    <span class="help-block"><?php echo Lang::T('Enter your WhatsApp phone number with country code (without +
                        sign)');?>
</span>
                </div>
                <div id="wga-pairing-loading" style="display:none; text-align:center; padding: 20px;">
                    <i class="glyphicon glyphicon-refresh glyphicon-spin" style="font-size: 24px;"></i>
                    <p><?php echo Lang::T('Getting pairing code...');?>
</p>
                </div>
                <div id="wga-pairing-result" style="display:none;">
                    <div class="alert alert-warning text-center">
                        <p><strong><?php echo Lang::T('Your Pairing Code:');?>
</strong></p>
                        ...
                        <div id="wga-pairing-status" style="margin: 15px 0;">
                            <i class="glyphicon glyphicon-refresh glyphicon-spin"></i>
                            <span id="wga-pairing-status-text"><?php echo Lang::T('Waiting for connection...');?>
</span>
                        </div>
                        <p class="text-muted">
                            <strong><?php echo Lang::T('How to use:');?>
</strong><br>
                            1. <?php echo Lang::T('Open WhatsApp on your phone');?>
<br>
                            2. <?php echo Lang::T('Go to Settings > Linked Devices');?>
<br>
                            3. <?php echo Lang::T('Tap "Link a Device"');?>
<br>
                            4. <?php echo Lang::T('Tap "Link with phone number instead"');?>
<br>
                            5. <?php echo Lang::T('Enter this code');?>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="wga-pairing-btn" onclick="wgaGetPairingCode()">
                    <i class="glyphicon glyphicon-link"></i> <?php echo Lang::T('Get Pairing Code');?>
...
plugin/wga_sendMessage&phone=[number]&message=[text]&secret=<?php echo md5($_smarty_tpl->tpl_vars['_c']->value['api_key']);?>
">
    ...
    <p class="text-muted"><small>Copy the API URL and paste it in SMS Server URL field in SMS
            Settings.</small></p>
    <p class="text-muted">If you update the API Token in <a href="<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
settings/app">Settings > General Settings > API
    ...
    <div class="panel-heading">
        <h4 class="panel-title">
            <a data-toggle="collapse" href="#wga-install-instructions" style="text-decoration: none;">
                <i class="glyphicon glyphicon-info-sign"></i> <?php echo Lang::T('WhatsApp Server Installation Guide');?>
...
>
    document.addEventListener('DOMContentLoaded', function () {
        var wgaBaseUrl = '<?php echo $_smarty_tpl->tpl_vars['_url']->value;?>
';
        var wgaConnectionCheckInterval = null;
        var wgaInitialDeviceCount = <?php if ($_smarty_tpl->tpl_vars['devices']->value) {
echo smarty_modifier_count($_smarty_tpl->tpl_vars['devices']->value);
} else { ?>0<?php }?>;
    ...
    var wgaActiveDeviceId = '<?php echo (($tmp = strtr((string)$_smarty_tpl->tpl_vars['_c']->value['alt_wga_device_id'], array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
                       "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
...
';
    ...
    if (versionEl) {
        ...
        var productName = "<?php echo $_smarty_tpl->tpl_vars['productName']->value;?>
";
        var version = "<?php echo $_smarty_tpl->tpl_vars['version']->value;?>
";
