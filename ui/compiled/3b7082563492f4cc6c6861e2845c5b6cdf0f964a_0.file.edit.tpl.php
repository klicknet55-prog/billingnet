<?php
/* Smarty version 4.5.3, created on 2026-04-18 00:42:49
  from 'F:\xampp\htdocs\billingnet\ui\ui\admin\customers\edit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_69e271195cf0a4_79120545',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3b7082563492f4cc6c6861e2845c5b6cdf0f964a' => 
    array (
      0 => 'F:\\xampp\\htdocs\\billingnet\\ui\\ui\\admin\\customers\\edit.tpl',
      1 => 1763342386,
      2 => 'file',
    ),
  ),
...
function content_69e271195cf0a4_79120545 (Smarty_Internal_Template $_smarty_tpl) {
...
/user.default.jpg'" class="img-circle img-responsive"
                            alt="Photo" onclick="return deletePhoto(<?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
)">
                    </center><br>
...
">
                    <div class="form-group">
                        ...
                        <div class="form-group col-md-3 col-xs-4" title="Not always Working">
                            <label class=""><input type="checkbox" checked name="faceDetect" value="yes"> <?php echo Lang::T("Face Detection");?>
</label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select class="form-control" id="service_type" name="service_type">
                                ...
                                <option value="VPN" <?php if ($_smarty_tpl->tpl_vars['d']->value['service_type'] == 'VPN') {?>selected<?php }?>>VPN</option>
                                <option value="Others" <?php if ($_smarty_tpl->tpl_vars['d']->value['service_type'] == 'Others') {?>selected<?php }?>><?php echo Lang::T("Other");?>
</option>
                            </select>
                        </div>
                    </div>
...
:
                                <?php echo Lang::T('Customer can login but cannot buy internet package, Admin cannot recharge customer');?>
.<br>
                                <?php echo Lang::T("Don't forget to deactivate all active package too");?>
.
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" id="pppoe_ip" name="pppoe_ip"
                                onkeyup="checkIP(this, <?php echo $_smarty_tpl->tpl_vars['d']->value['id'];?>
)" value="<?php echo $_smarty_tpl->tpl_vars['d']->value['pppoe_ip'];?>
">
                            <span class="help-block"><?php echo Lang::T('Not Working with Freeradius Mysql');?>
</span>
                        </div>
...
">
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label"><?php echo Lang::T('Zip Code');?>
</label>
                        <div class="col-md-9">
